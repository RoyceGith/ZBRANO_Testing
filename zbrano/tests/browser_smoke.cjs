...
const onboardingFixture = {
  ...
  installation_report: {
    generated_at: 1788300000, version: "0.13.251", ready: true, attention_count: 0, ready_count: 5,
    checks: [
...
function apiFixture(url, method = "GET") {
  ...
  if (pathname === "/api/release-memory-sync") {
    return {enabled: false, state: "disabled", version: "0.13.251", task_active: false};
  }
