...
class V013131PaletteTests(unittest.TestCase):
    def test_release_is_aligned(self):
        ...
        self.assertIn('version: "0.13.252"', (ROOT / "zbrano" / "config.yaml").read_text(encoding="utf-8"))
        self.assertIn('version="0.13.252"', (ROOT / "zbrano" / "app" / "main.py").read_text(encoding="utf-8"))
        self.assertIn("HUD 0.13.252", (ROOT / "zbrano" / "app" / "static" / "index.html").read_text(encoding="utf-8"))
