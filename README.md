...
Version 0.13.252 fixes disabled-device precedence and separates attachments from commands.
Model-selected local changes require approval of the proposed actions.
